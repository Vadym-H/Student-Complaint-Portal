...
# NOTE: Azure App Service (PaaS) terminates HTTPS at the platform level.
# This application runs HTTP-only internally and is not responsible for TLS/SSL.
# Azure App Service automatically:
# - Handles HTTPS with Azure-managed certificates
# - Redirects HTTP to HTTPS
# - Manages certificate renewal
# See: https://learn.microsoft.com/en-us/azure/app-service/configure-ssl-app-service-managed-certificate# Health check
